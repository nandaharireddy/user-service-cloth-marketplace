...
`api-design.md`, and `auth-and-security.md` for what to build; this file governs _how_
to build it.
...
- **Every public method** (Controller, Service, DAO, Repository) gets a Javadoc block
  ...
  ```
- Inline comments (`//`) are for _why_, not _what_ — only add them where logic isn't
